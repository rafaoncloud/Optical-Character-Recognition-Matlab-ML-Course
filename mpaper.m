...
% dois mil e dezanove.
% Digitalização de um carater desenhado manualmente .
...
% ai como a matriz T. No entanto é preferível usar para este efeito o
...
%Resumindo:
% 1� Corre-se mpaper (sem fazer classificação, comentando a linha feval número 209 neste ficheiro)

% 2� Desenham-se caracteres em número suficiente, um em cada quadrícula
...
% combina��o Shift+botão esquerdo  (Shift para mai�sculas).
