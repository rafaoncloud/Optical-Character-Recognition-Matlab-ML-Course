function network = trainingNetwork()
    ...
    if(architecture == 1)      %Associative Memory + Classifier
            ...
            if(activationFunction == 1)         %hardlim
                ...
                if(dataSet == 1)  
                    if(validate == 1)hardLimA1D1V1 = net;save hardLimA1D1V1;
                    elseif(validate == 2)hardLimA1D1V2 = net;save hardLimA1D1V2;
                    end
                    
                else  
                    if(validate == 1)hardLimA1D2V1 = net;save hardLimA1D2V1;
                    elseif(validate == 2)hardLimA1D2V2 = net;save hardLimA1D2V2;
                    end
                end
            ...
            elseif(activationFunction == 2)           %linear
                ...
                if(dataSet == 1)  
                    if(validate == 1)pureLinA1D1V1 = net;save pureLinA1D1V1;
                    elseif(validate == 2)pureLinA1D1V2 = net;save pureLinA1D1V2;
                    end
                else 
                    if(validate == 1)pureLinA1D2V1 = net;save pureLinA1D2V1;
                    elseif(validate == 2)pureLinA1D2V2 = net;save pureLinA1D2V2;
                    end
                end
            ...
            elseif(activationFunction == 3)     %Logsig (Sigmoid trasnfer Function)
                ...
                if(dataSet == 1)  
                    if(validate == 1)logSigA1D1V1 = net;save logSigA1D1V1;
                    elseif(validate == 2)logSigA1D1V2 = net;save logSigA1D1V2;
                    end
                else 
                    if(validate == 1)logSigA1D2V1 = net;save logSigA1D2V1;
                    elseif(validate == 2)logSigA1D2V2 = net;save logSigA1D2V2;
                    end
                end
 ...
 %sim(net,P13) % simulates the specified model using the parameter values specified in the structure ParameterStruct.
                ...
                if(dataSet == 1)  
                    if(validate == 1)hardLimA2D1V1 = net;save hardLimA2D1V1;
                    elseif(validate == 2)hardLimA2D1V2 = net;save hardLimA2D1V2;
                    end
                    
                else  
                    if(validate == 1)hardLimA2D2V1 = net;save hardLimA2D2V1;
                    elseif(validate == 2)hardLimA2D2V2 = net;save hardLimA2D2V2;
                    end
                end
            ...
            elseif(activationFunction == 2)           %linear
                ...
                if(dataSet == 1)  
                    if(validate == 1)pureLinA2D1V1 = net;save pureLinA2D1V1;
                    elseif(validate == 2)pureLinA2D1V2 = net;save pureLinA2D1V2;
                    end
                else 
                    if(validate == 1)pureLinA2D2V1 = net;save pureLinA2D2V1;
                    elseif(validate == 2)pureLinA2D2V2 = net;save pureLinA2D2V2;
                    end
                end
            ...
            elseif(activationFunction == 3)     %Logsig (Sigmoid trasnfer Function)
                ...
                if(dataSet == 1)  
                    if(validate == 1)logSigA2D1V1 = net;save logSigA2D1V1;
                    elseif(validate == 2)logSigA2D1V2 = net;save logSigA2D1V2;
                    end
                else 
                    if(validate == 1)logSigA2D2V1 = net;save logSigA2D2V1;
                    elseif(validate == 2)logSigA2D2V2 = net;save logSigA2D2V2;
                    end
                end
